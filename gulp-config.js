...
*/
config.env = {};
config.env.definitions = require(__dirname + '/inc/environment_definitions.json');
var current = require(__dirname + '/inc/environment.json');
...
*/
config.js = {};
config.js.SOURCE_DIR = __dirname + '/js/';
config.js.DEST_DIR = __dirname + '/public_html/scripts/';
...
*/
config.styles = {};
config.styles.SOURCE_DIR = __dirname + '/sass/';
config.styles.DEST_DIR = __dirname + '/public_html/styles/';
